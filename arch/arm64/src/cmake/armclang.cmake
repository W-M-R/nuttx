...
add_compile_options(-fno-builtin --target=aarch64-aarch64-none-eabi)
add_link_options(--target=aarch64-aarch64-none-eabi)
...
set(PREPROCESS ${CMAKE_C_COMPILER} ${CMAKE_C_FLAG_ARGS} -E -P -x c --target=aarch64-aarch64-none-eabi)
